...
import AlmacenCharts from './almacen-charts'
import LogisticaCharts from './logistica-charts'
import EquiposCharts from './equipos-charts'
import SsommaCharts from './ssomma-charts'
