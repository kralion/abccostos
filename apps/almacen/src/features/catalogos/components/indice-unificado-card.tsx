...
type IndiceUnificadoCardProps = {
  indiceUnificado: IndiceUnificado
}

export function IndiceUnificadoCard({ indiceUnificado }: IndiceUnificadoCardProps) {
  return (
    <div className='bg-background flex flex-col gap-3 rounded-md border p-4'>
      <div className='flex items-start justify-between gap-3'>
        <div className='min-w-0'>
          ...
          <div className='font-medium'>{indiceUnificado.codigo}</div>
        </div>
