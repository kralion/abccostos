...
export function RecursosCards() {
  const totalValorInventario = recursosData.reduce((sum, item) => sum + item.valorTotal, 0)
  const totalItems = recursosData.length
  ...
  return (
    <div className='space-y-6'>
      ...
      <div className='grid gap-6 md:grid-cols-2'>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Movimientos de Recursos</CardTitle>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width='100%' height={300}>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Valor de Recursos por Categoría</CardTitle>
        </CardHeader>
        <CardContent>
          <ResponsiveContainer width='100%' height={300}>
