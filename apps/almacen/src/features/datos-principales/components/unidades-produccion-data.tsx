          ...
          <table className='w-full'>
            <thead className='border-b bg-gray-100'>
              <tr>
                ...
                <th className='p-3 text-right text-sm font-semibold'>Imagen</th>
            ...
            <tbody>
              {mockData.map((item, index) => (
                ...
                >
                  ...
                  <td className='p-3 text-sm'>{item.unidadProduccion}</td>
